...
?>
    <div class=" col-10 ">
     ...
     <nav class="navbar navbar-light bg-light">
        ...
        <table class="table table-hover table-bordered adabiatcolor align-middle">
            <thead>
            ...
            <tbody>
              <tr>
                ...
                <td>Otto</td>
                <td>@mdo</td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-outline-success ">حذف</button></td>
