...
<div class=" col-10">
  <button type="button" class="btn btn-outline-warning "><a href="sabtkarbar.php"> افزودن کاربر</a></button>
  <br><br>
    ...
    <thead>
      ...
      ?>
            <tr>
              ...
              <td>
                <button type='button' class='btn btn-outline-danger'><a class='text-black' href="a-editkarbar.php?edit=<?= $row['codemeli']; ?>"> ویرایش</a></button>
                <button type='button' class='btn btn-outline-warning'><a href="config/deletekarbar.php?delete=<?= $row['codemeli']; ?>" class='text-black'>حذف</a></button>
              </td>
            </tr>
        ...
        if (mysqli_num_rows($query_run) > 0) :
          foreach ($query_run as $items) : ?>
            ...
            <td><?= $items['ردیف']; ?></td>
              ...
              <td>
                <button type='button' class='btn btn-outline-danger'><a class='text-black' href="a-editkarbar.php?edit=<?= $items['codemeli']; ?>"> ویرایش</a></button>
                <button type='button' class='btn btn-outline-warning'><a href="config/deletekarbar.php?delete=<?= $items['codemeli']; ?>" class='text-black'>حذف</a></button>
              </td>
            </tr>
          <?php
          endforeach;
