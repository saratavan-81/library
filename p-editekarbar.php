<?php include './header/personel-header.php' ?>
...
if (isset($_GET['edit'])) {
    ...
    if ($result->num_rows == 1) {
        ...
        $namekarbar = $row['namekarbar'];
        $familykarbar = $row['familykarbar'];
        ...
        $safheavalvadvomshenasname  = $row['safheavalvadvomshenasname'];
        $imagekarbar = $row['imagekarbar'];
        $address  = $row['address'];
        $codemeli = $row['codemeli'];
        $oldcodemeli  = $row['codemeli'];
...
?>
        ...
        <div class="col-9">
            ...
            <div class="sabtp">
                ...
                <form action="./config/p-updatekarbar.php" role="form" method="POST" enctype="multipart/form-data" class="p-5 container needs-validation textcolorp border border-warning border-3 rounded" novalidate>

                    <div class="row ">
                        <div class="  col-md-6 shadow ">
                            <label class="form-label"> نام کاربر </label>
                            <div class="input-group  has-validation ">
                                <input name="namekarbar" type="text" class="form-control" value="<?=  $namekarbar ?>" required>
                        ...
                        <div class="  col-md-6 shadow ">
                            ...
                            <div class="input-group  has-validation ">
                                <input name="familykarbar" type="text" class="form-control" value="<?= $familykarbar ?>" required>
                                <div class="invalid-feedback">
                    ...
                    <div class="row ">
                        ...
                        <div class=" shadow">
                            ...
                            <input name="password" pattern='[0-9]{10}' type="password" class="form-control" value="<?= $password  ?>" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="input-group  has-validation shadow  ">
                        <input name="phonekarbar" pattern='[0-9]{11}' type="text" class="text-end form-control" value="<?= $phone1 ?>" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 shadow pb-3 col-md-6 ">
                            ...
                            <div class="input-group mb-3">
                                <input name="sheeno" type="file" class="form-control" >
                                    ...
                                    <div class="modal-dialog" style="max-width: fit-content;">
                                        <div class="modal-content">
                                            <div class="modal-body p-0">
                                                <img src="<?= $safheavalvadvomshenasname ?>" width="400px" height="400px">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="mb-3 shadow pb-3 col-md-6 ">
                            <label class="form-label"> عکس کاربر </label>
                            <div class="input-group mb-3">
                                <input name="persso" type="file" class="form-control" >
                                ...
                                <div class="modal fade" id="persmodal" tabindex="-1" aria-labelledby="persmodal" aria-hidden="true">
                                    <div class="modal-dialog" style="max-width: fit-content;">
                                        <div class="modal-content">
                                            <div class="modal-body p-0">
                                                <img src="<?= $imagekarbar ?>" width="400px" height="400px">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row text-black">
                            <div class="col  bg-light  p-4  border shadow ">
                                <div class="overflow-auto">
                                    <p> سایت <mark>کتاب یار</mark>،سایت جامع مدیریت کتاب ها با همکاری کتابخانه کناب یار با <strong>هدف رفع مشکلات کتابخانه</strong>، به منظور پیاده سازی یک سیستم جامع ، تحت وب ، یکپارچه و متمرکز ،<u> مورد استفاده برای پرسنل کتابخانه و کاربران</u> با حداکثر ظرفیت کتاب ها با موضوعات مختلف ، طرح ریزی و پیاده سازی شده است  </p>
                                </div>
                                <div class="col-12">
...
<?php }
    ...
    die("<script>
    window.alert('لطفا کاربری را جهت ویرایش انتخاب کنید');
