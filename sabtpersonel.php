...
<div class="col-9  ">
  ...
  <div class="sabtp">
    ...
    <form action="config/registerpersonel.php" role="form" method="POST" enctype="multipart/form-data" class="p-5 container needs-validation textcolorp border border-warning border-3 rounded" novalidate>

      <div class="row ">
        <div class="  col-md-6 shadow ">
          <label class="form-label"> نام پرسنل </label>
          <div class="input-group  has-validation ">
            <input name="namepersonel" type="text" class="form-control" placeholder="نام..." required>
        ...
        <div class="  col-md-6 shadow ">
          ...
          <div class="input-group  has-validation ">
            <input name="familypersonel" type="text" class="form-control" placeholder="نام خانوادگی... " required>
            <div class="invalid-feedback">
      ...
      <div class="row ">
        <div class=" col-md-6 shadow ">
          ...
          <input name="codepersoneli" pattern='[0-9]{10}' type="password" class="form-control" placeholder="2284561231" required>
          <div class="invalid-feedback">
      ...
      <div class="col shadow ">
        ...
        <input name="adamsopishine" class="form-control" list="sabqelist" placeholder=" ..." required>
      ...
      <div class="row">
        ...
        <div class="col-md-6 shadow ">
          ...
          <input name="shen" type="file" class="form-control" required>
          <div class="invalid-feedback">
            لطفا اسکن صفحه اول و دوم شناسنامه را انتخاب کنید.
          </div>
        </div>

        <div class="col-md-6 shadow ">
          <label class="form-label">اپلود عکس پرسنلی </label>
          <input name="pers" type="file" class="form-control" required>
          <div class="invalid-feedback">
