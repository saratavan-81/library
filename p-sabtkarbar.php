...
<div class="col-9  ">
    ...
    <div class="sabtp">
        ...
        <form action="config/p-registerkarbar.php" role="form" method="POST" enctype="multipart/form-data" class="p-5 container needs-validation textcolorp border border-warning border-3 rounded" novalidate>
