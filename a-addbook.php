...
<br><br>
  <div class="addbook container">
    ...
    <form class="p-5 container needs-validation text-primary border border-warning border-3 rounded" role="form" method="POST" enctype="multipart/form-data" action="config/a-ddbook.php" novalidate>
