...
<div class="col-9 ms-5">
    ...
    <div class="addbook container">
        ...
        <form class="p-5 container needs-validation text-primary border border-warning border-3 rounded" role="form" method="POST" action="./config/p-updatebook.php" enctype="multipart/form-data" novalidate>
